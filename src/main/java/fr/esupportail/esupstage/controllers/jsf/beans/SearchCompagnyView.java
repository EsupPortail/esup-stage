...
@Named("searchCompagnyView")
@ViewScoped
public class SearchCompagnyView implements Serializable {
		...
		private static OkHttpClient getUnsafeOkHttpClient() {
				...
				public void searchCompagny() throws IOException {
						...
						for(Object obj : etabs){
								...
								juridique.setLibelleStatutJuridique(etab.optString("libelle_nature_juridique_entreprise"));
								...
								structure.setIdStructure(new SecureRandom().nextInt(9999));
