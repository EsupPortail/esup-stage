...
ESUP-Stage met à disposition des api "public" accessible avec un des tokens paramétrés dans `appli.tokens`. La liste des api se trouve dans `/public/swagger-ui.html`.
