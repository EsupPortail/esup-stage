...
* *Saisir sa convention de stage* +
  xref:attachment$TUTORIEL-ETUDIANT-Formation-Initiale.pdf[Consulter le tutoriel]
* *Guide du gestionnaire de stage* +
  xref:attachment$TUTORIEL-GESTIONNAIRE-Formation-Initiale.pdf[Consulter le tutoriel]
